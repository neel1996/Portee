...
$mel = (int) ($len + $len_1);
	...
	$res_1 = mysqli_query($con,"SELECT id FROM usertab WHERE email='$email'");
	$fin_1 = mysqli_fetch_array($res_1);
	$val_1 = $fin_1['id'];
	
	mysqli_query($con,"UPDATE core SET prev_key='$val',cur_key='$confirm_code' WHERE id='$val_1'"); 
	echo 'complete';
